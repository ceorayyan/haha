      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-zinc-500 text-sm mb-8">
            Join thousands of researchers using Rayyan
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 bg-zinc-800 border border-zinc-700 rounded text-white focus:ring-2 focus:ring-white/20 focus:ring-offset-0"
              />
            ...
            <button
              ...
              className="w-full bg-white text-black font-semibold rounded-lg py-2.5 text-sm hover:bg-zinc-200 active:bg-zinc-300 transition disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white"
            >
              Create account
            </button>
          </form>
