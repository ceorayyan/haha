      ...
      <div className="space-y-3">
        ...
        <div className="bg-white dark:bg-[var(--surface-1)] rounded-lg border border-[var(--border-subtle)] p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-1">Statanex Reference ID:</h3>
              <p className="text-sm text-[var(--text-secondary)] font-mono">{article.reference_id || `STX-${String(article.id).padStart(8, '0')}`}</p>
            </div>
          </div>
        </div>
