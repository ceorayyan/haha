          ...
          <tr ref={observerTarget}>
            <td colSpan={5} className="py-2">
              {loading && articles.length > 0 && (
                <div className="space-y-2">
                  {Array.from({ length: 2 }).map((_, idx) => (
                    <div key={`loading-${idx}`} className="animate-pulse flex items-start gap-4 p-4 border-b border-[var(--border-subtle)]">
                      <div className="w-4 h-4 bg-[var(--surface-2)] rounded shrink-0 mt-1"></div>
                      <div className="flex-1 space-y-2">
                        <div className="h-4 bg-[var(--surface-2)] rounded w-3/4"></div>
                        <div className="h-3 bg-[var(--surface-2)] rounded w-1/2"></div>
                      </div>
                      <div className="flex gap-2">
                        <div className="w-20 h-8 bg-[var(--surface-2)] rounded"></div>
                        <div className="w-20 h-8 bg-[var(--surface-2)] rounded"></div>
                      </div>
                    </div>
                  ))}
              ...
              {!hasMore && articles.length > 0 && (
                <p className="text-sm text-[var(--text-muted)] text-center py-4">No more duplicates</p>
              )}
            </td>
          </tr>
        </>
